    ...
    render() {
        return (
            <div className="w3_agileits_contact_grids">
                <div className="col-md-6 col-xs-8 w3_agileits_contact_grid_left">
                    <div className="agile_map">
                        <Iframe
                            url="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3950.3905851087434!2d-34.90500565012194!3d-8.061582082752993!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x7ab18d90992e4ab%3A0x8e83c4afabe39a3a!2sSport+Club+Do+Recife!5e0!3m2!1sen!2sin!4v1478684415917"
                            style="border:0"
                        />
                    </div>
                ...
                <div className="col-md-6 w3_agileits_contact_grid_right">
                    <h3 className="agileits-title">Contact<span className="w3lshr-line"> </span></h3>
                    <form action="#" method="post">
					<span className="input input--ichiro">
						<input className="input__field input__field--ichiro" type="text" id="input-25" name="Name"
                        ...
                        <span className="input input--ichiro">
						<input className="input__field input__field--ichiro" type="email" id="input-26" name="Email"
                               placeholder=" " required=""/>
